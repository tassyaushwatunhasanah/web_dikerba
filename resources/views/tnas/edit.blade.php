...
@section('title', 'Edit Detail TNA')

@section('content_header')
    <h1 class="m-0 text-dark">Edit Data Detail TNA</h1>
@stop

@section('content')
    <form action="/tnas/update/{{$tna['id']}}" method="post" enctype="multipart/form-data">
        @method('patch')
        @csrf
        <div class="row">
            <div class="col-12">
                ...
                <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('no_pegawai') is-invalid @enderror" id="no_pegawai" placeholder="Nomor Pegawai" name="no_pegawai" value="{{$tna->pegawai_id}}">
                            @error('no_pegawai') <span class="text-danger">{{$message}}</span> @enderror
                        </div>
                        <div class="mb-3">
                            <input type="hidden" name="tna_id" value="{{$tna->tna_id}}">
                        </div>
                        <div class="form-group">
                            <input type="hidden" id="pegawai_id" name="pegawai_id" value="{{$tna->pegawai_id}}">
                        </div>
                        <!-- Pegawai -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('umur') is-invalid @enderror" id="umur" placeholder="Angka umur" name="umur" value="{{$tna->umur}}">
                            @error('umur') <span class="text-danger">{{$message}}</span> @enderror
                        </div>
                        <div class="form-group">
                            <label for="lama_kerja_rs">Lama Kerja di RS</label>
                            <input type="number" class="form-control @error('lama_kerja_rs') is-invalid @enderror" id="lama_kerja_rs" placeholder="Angka lama kerja di RS" name="lama_kerja_rs" value="{{$tna->lama_kerja_rs}}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('lama_kerja_skrg') is-invalid @enderror" id="lama_kerja_skrg" placeholder="Angka lama kerja di tempat sekarang" name="lama_kerja_skrg" value="{{$tna->lama_kerja_skrg}}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" cols="50" class="form-control @error('kompetensi') is-invalid @enderror" id="kompetensi" placeholder="Kompetensi sesuai tupoksi" name="kompetensi">{{$tna->kompetensi}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" cols="50" class="form-control @error('masalah') is-invalid @enderror" id="masalah" placeholder="Masalah yang dihadapi terhadap kompetensi" name="masalah">{{$tna->masalah}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" cols="50" class="form-control @error('pelatihan_2_thn') is-invalid @enderror" id="pelatihan_2_thn" placeholder="Pelatihan 2 tahun terakhir" name="pelatihan_2_thn" >{{$tna->pelatihan_2_thn}}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" cols="50" class="form-control @error('pelatihan_tupoksi') is-invalid @enderror" id="pelatihan_tupoksi" placeholder="Pelatihan sesuai tupoksi" name="pelatihan_tupoksi">{{$tna->pelatihan_tupoksi}}</textarea>
