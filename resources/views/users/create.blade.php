...
@section('title', 'Tambah Akun User | Website Dikerba')

@section('content_header')
    <h1 class="m-0 text-dark">Tambah Akun User</h1>
@stop
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @error('role') <span class="text-danger">{{$message}}</span> @enderror
                                <select type="text" class="form-control @error('role') is-invalid @enderror" id="exampleInputRole" placeholder="Role" name="role" value="{{old('role')}}">
