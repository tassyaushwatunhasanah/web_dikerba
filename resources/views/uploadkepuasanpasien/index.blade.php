...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
            <div class="card-body">
            <form action="{{route('uploadkepuasanpasien.store')}}" method="post" enctype="multipart/form-data">
        @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                @if( in_array(pathinfo($item->file, PATHINFO_EXTENSION), ['png', 'jpg', 'JPEG']))
                                    <img src="{{asset('file_uploadkepuasanpasien')}}/{{$item->file}}" style="height: 40px">
                                @else
                                    <img src="https://www.freeiconspng.com/uploads/file-txt-icon--icon-search-engine--iconfinder-14.png"
                                    style="height: 40px">
                                @endif
                            </td>
                            <td align="center"><a href="{{asset('file_uploadkepuasanpasien')}}/{{$item->file}}" download>Download</a></td>
